...
<body>
    ...
    <div style="page-break-before:always;">
        ...
        <table style="width:100%; margin-top:5px;border-collapse: collapse; font-family: calibri;" collapse="0">
            ...
            <tr>
                <td>b. Telah mendapatkan penjelasan serta mendapatkan leaflet tentang hak dan kewajiban pasien di </td>
            </tr>
            <tr>
                <td> &nbsp;&nbsp;&nbsp;&nbsp;Puskesmas Segiri seperti tercantum dalam lembar ini.</td>
            </tr>
        </table>
        <table border="1" style="width:100%; border-collapse: collapse; margin-top:20px;" collapse="0">
            <tr style="">
