    ...
    <div class="card-footer">
            <div class="col-md-12 col-lg-12 col-sm-12 form-group row">
                <div class="col-md-12 col-sm-12 col-lg-3">
                        <a target="_blank" class="col-md-12 col-sm-12 col-lg-12 btn btn-danger float-left btn-sm text-sm float-left" href="cetakKunjungan/{{$tanggalMulai}}/{{$tanggalSampai}}"><i class="fa fa-print text-xs"></i>  PDF</a>
                </div>
