    ...
    <div class="card card-warning card-outline">
        ...
        <div class="card-body">
            ...
            <div class="form-group row" style="margin-bottom: 5px;">
                <label class="col-md-4 col-sm-12 col-lg-4 col-form-label text-xs">ID Jaminan</label>
                <div class="col-md-5 col-lg-7 col-sm-12">
                    <input wire:model.defer='id_jaminan' class="rounded-0 form-control form-control-sm @error('id_jaminan')is-invalid @enderror">
                    @error('id_jaminan') <span class="invalid-feedback"> {{$message}} </span> @enderror
                </div>
            </div>
            <div class="form-group row" style="margin-bottom: 5px;">
                <label class="col-md-4 col-form-label text-xs" >Nama Jaminan</label>
                <div class="col-md-5 col-lg-7 col-sm-12 text-xs">
                    <input wire:model.defer='jaminan' class="form-control form-control-sm rounded-0 @error('jaminan')is-invalid @enderror">
                    @error('jaminan') <span class="invalid-feedback"> {{$message}} </span> @enderror
                </div>
            </div>
            <div class="form-group row text-xs" style="margin-bottom:5px;">
                <label class="col-md-4 col-sm-12 col-lg-4 col-form-label text-xs">Status Jaminan</label>
                <div class="col-md-5 col-lg-7 col-sm-12">
