                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row ">
                                    <label class="col-md-4 control-label">No. Rekam Medis  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                   <label class="col-md-4 control-label">Nama Lengkap  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label ">Tempat Lahir  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row ">
                                    <label class="col-md-4 control-label ">Tanggal Lahir  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row ">
                                    <label class="col-md-4 control-label">Kepala Keluarga  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Kelamin  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Agama  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Pekerjaan <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">No. Telepon / HP  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span class="text-xs text-danger">* Kosongkan Jika Pasien Tidak Memiliki NIK Khusus Pasien Berumur < 5 Tahun</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">  BPJS</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-lg-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Provinsi  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-lg-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Kab/Kota  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-lg-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Kecamatan  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-lg-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Kelurahan / Desa  <code>*</code></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12" style="margin-bottom:-8px;">
                                <div class="form-group row">
                                    <label class="col-md-4 control-label">Alamat  <code>*</code></label>
                                    <div class="col-md-8">
