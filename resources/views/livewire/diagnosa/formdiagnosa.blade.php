        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="form-group row"style="margin-bottom:-10px;">
                    <label class="col-md-5 text-sm col-form-label">REKAM MEDIS</label>
                    <label class="control-label text-sm col-sm-6 text-uppercase" >{{$no_Rm}}</label>
                </div>
                <div class="form-group row"style="margin-bottom:-10px;">
                    <label class="col-md-5 text-sm col-form-label">Nama</label>
                    <label class="control-label text-sm col-sm-6">{{$nama}}</label>
                </div>
                <div class="form-group row" style="margin-bottom:-10px;">
                    <label class="col-md-5 text-sm col-form-label">TANGGAL LAHIR</label>
                    <label class="control-label text-sm col-sm-6">{{$tgl_lahir}}</label>
                </div>
                <div class="form-group row" style="margin-bottom:-10px;">
                    <label class="col-md-5 text-sm col-form-label">Jenkel</label>
                ...
                <form wire:submit.prevent='test'> 
                    <label class="control-label" style="margin-top:15px;">Diagnosa</label>
